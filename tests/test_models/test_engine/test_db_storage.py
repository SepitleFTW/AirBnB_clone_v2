#!/usr/bin/python3
"""Contains test cases for the DBStorage class."""
...
class TestDBStorageDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_test_db_storage(self):
        """Test that tests/test_models/test_engine/test_db_storage.py conforms to PEP8."""
        pep8s = pycodestyle.StyleGuide(quiet=True)
...
class TestFileStorage(unittest.TestCase):
    ...
    @unittest.skipIf(storage_t != 'db', "not testing db storage")
    def test_new(self):
        """Test adds an object to the database."""

    @unittest.skipIf(storage_t != 'db', "not testing db storage")
    def test_save(self):
        """Test that save properly."""
