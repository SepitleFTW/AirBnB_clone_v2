...
class TestAmenity(test_basemodel):
    ...
    def __init__(self, *args, **kwargs):
        """Initializes test cases for the Amenity class."""
...
class TestPEP8(unittest.TestCase):
    ...
    def test_pep8_user(self):
        """Test the PEP8 style for 'amenity.py'."""
...
class TestInheritBaseModel(unittest.TestCase):
    """Test cases for inheritance from BaseModel."""
...
class TestAmenityBaseModel(unittest.TestCase):
    """Test cases for the Amenity class inheriting BaseModel."""
    def test_instances(self):
        """Test creating instances of Amenity."""
    ...
    def test_user_id_and_created_at(self):
        """Test the 'id' and 'created_at' attributes."""
        user_1 = Amenity()
        sleep(2)
        user_2 = Amenity()
        sleep(2)
...
class TestAmenity(unittest.TestCase):
    ...
    def test_str(self):
        """test if string method will have correct output"""
        amenity = Amenity()
